<template>
	<div style="height: 100%;width: 60%;margin: 0 auto;background:white;">
		...
		<div class="content" style="overflow-x: auto;">
			<mavon-editor :value="value" :subfield="prop.subfield" :defaultOpen="prop.defaultOpen" 
				:toolbarsFlag="prop.toolbarsFlag" :editable="prop.editable" :scrollStyle="prop.scrollStyle"></mavon-editor>
		</div>
